...
CREATE TABLE IF NOT EXISTS `externatic`.`consultant` (
  ...
  INDEX `fk_consultant_region1_idx` (`regionId` ASC) VISIBLE,
  CONSTRAINT `fk_consultant_region1`
...
-- -----------------------------------------------------
-- Table `externatic`.`consultant_candidate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `externatic`.`consultant_candidate` (
  `consultantId` INT NOT NULL,
  `consultantRegionId` INT NOT NULL,
  `candidateId` INT NOT NULL,
  PRIMARY KEY (`consultantId`, `consultantRegionId`, `candidateId`),
  INDEX `fk_consultant_has_candidate_candidate1_idx` (`candidateId` ASC) VISIBLE,
  INDEX `fk_consultant_has_candidate_consultant1_idx` (`consultantId` ASC, `consultantRegionId` ASC) VISIBLE,
  CONSTRAINT `fk_consultant_has_candidate_consultant1`
    FOREIGN KEY (`consultantId` , `consultantRegionId`)
    REFERENCES `externatic`.`consultant` (`id` , `regionId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_consultant_has_candidate_candidate1`
